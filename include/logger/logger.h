...
#define slog_info(fmt, ...) { log_info(fmt, ##__VA_ARGS__); store_message(LOG_LEVEL_INFO, "info", __FILE_NAME__, __LINE__, fmt, ##__VA_ARGS__); }
#define slog_error(fmt, ...) { log_error(fmt, ##__VA_ARGS__); store_message(LOG_LEVEL_ERROR, "error", __FILE_NAME__, __LINE__, fmt, ##__VA_ARGS__); }
#define slog_warning(fmt, ...) { log_warning(fmt, ##__VA_ARGS__); store_message(LOG_LEVEL_WARNING, "warning", __FILE_NAME__, __LINE__, fmt, ##__VA_ARGS__); }
